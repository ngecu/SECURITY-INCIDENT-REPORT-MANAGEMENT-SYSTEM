  ...
  return (
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
        ...
        {loadingVoteheadList ? <Loader/> : errorVoteheadList ? (
               <Result
               status="500"
               title="500"
...
<Row>
  ...
  <Col md={4} >
                <Button type="primary" className='w-100' onClick={handleNewVotehead}>New Votehead</Button>
              </Col>
</Row>
</Card>
...
<Card>
  ...
  {voteheads && voteheads.map((votehead, index) => (
    <tr key={index}>
      ...
      <td>
        <Button icon={<FaEye />} onClick={() => viewVoteheadDetails(votehead.id)} />
        <Button icon={<FaEdit />} onClick={() => editVotehead(votehead.id)} />
        <Button icon={<FaTrash />} onClick={() => deleteVotehead(votehead.id)} />
      </td>
    </tr>
  ))}
</tbody>
...
export default VoteheadScreenRegistrar;
